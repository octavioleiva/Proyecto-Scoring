...
uses
 ...
 const ruta_cond='C:\Users\gisela pontelli\Documents\TP Scoring\archivo_conductores.DAT';
 TYPE
   t_dato_cond=record
     dni:string[8];
     apellido:string[30];
 ...
 t_arch_cond=file of t_dato_cond;
  ...
  procedure leer_dato_archcond (var arch_cond:t_arch_cond; dato_cond:t_dato_cond;var pos:byte);
  procedure escribir_dato_archcond(var arch_cond:t_arch_cond;var dato_cond:t_dato_cond;pos:byte);
implementation
procedure crear_arch_cond(var arch_cond:t_arch_cond );
begin
